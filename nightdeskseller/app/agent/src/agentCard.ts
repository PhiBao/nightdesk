...
export function buildAgentCard(
  ...
  return {
    name,
    description: `NightDesk spread-truth reports for tokenized stocks on BSC — negotiate + notify_funded over A2A. Sells live session-aware execution reports (venues, on-chain vs reference spread, executability). (${name})`,
